...
First, set the environment variables in a `.env` file in the root of the project:
...
Open [http://localhost:45256](http://localhost:45256) with your browser to see the result.
